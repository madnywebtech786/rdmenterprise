        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            ...
            <div className="overflow-hidden">
              ...
              >
                Every Service You{" "}
                <span style={{ color: "#DF5B10" }}>Need</span>
              </motion.h2>
            </div>
          </div>
          <motion.p
          ...
          {servicesExtended.map((s, i) => {
            ...
            return (
              <button
                ...
                className={`inline-flex items-center gap-2 px-4 py-2.5 rounded-full border font-heading font-700 text-sm
              ...
              >
                <Icon size={14} className={isActive ? "text-secondary" : ""} />
                {s.label}
              </button>
            );
          })}
            ...
            >
              <div className="p-10 lg:p-14 flex flex-col justify-center bg-[#f8f7f4]">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="font-body text-sm text-[#0D1D46]/50 italic">{svc.tagline}</span>
                </div>
                ...
                >
                  {svc.features.map((f) => (
                    <li key={f} className="flex items-center gap-2.5 font-body text-sm text-[#0D1D46]/70">
              ...
              <div className="relative hidden lg:block min-h-[440px]">
                ...
                >
                  <Image src={svc.img} alt={svc.label} fill className="object-cover" sizes="480px" />
                  ...
                  <div className="absolute bottom-6 right-6 bg-[#0D1D46]/80 backdrop-blur-sm rounded-xl px-4 py-3 border border-white/10">
                    <div className="font-heading font-800 text-white text-sm">{svc.label}</div>
                    <div className="font-body text-white/50 text-xs mt-0.5">RDM Enterprises</div>
                  </div>
                </motion.div>
              </div>
            </motion.div>
          ...
          {servicesExtended.map((_, i) => (
            <button
              ...
              className={`rounded-full transition-all duration-300 ${
                active === i ? "w-6 h-1.5 bg-[#0D1D46]" : "w-1.5 h-1.5 bg-[#0D1D46]/20 hover:bg-[#0D1D46]/40"
              }`}
            />
          ))}
        </div>
